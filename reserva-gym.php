...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['fecha']) && isset($_POST['hora']) && isset($_POST['instalacion'])) {
    ...
    header("Location: reserva-gym.php");
    exit();
}
...
<body>
    ...
    <main>
        <div class="descripcion">
            <h2>Reserva del Campo de Fútbol</h2>
            <p>¡Reserva tu horario para disfrutar del campo de fútbol!</p>
        </div>
        ...
        <div class="detalles">
            ...
            <div class="informacion">
                <form method="POST" id="reserva-form" action="reserva-gym.php">
                    <!-- Campo oculto para pasar la instalación -->
                    <input type="hidden" name="instalacion" value="Gimnasio" />
