...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['fecha']) && isset($_POST['hora']) && isset($_POST['instalacion'])) {
    ...
    header("Location: reservas-sala.php");
    exit();
}
...
<body>
    ...
    <main>
        <div class="descripcion">
            <h2>Reserva del Campo de Fútbol Sala</h2>
            <p>¡Reserva tu horario para disfrutar del campo de fútbol Sala!</p>
        </div>

        <div class="detalles">
            <div class="imagen">
                <img src="img/Sala.png" alt="Campo de Fútbol Sala" />
            </div>

            <div class="informacion">
                <form method="POST" id="reserva-form" action="reservas-sala.php">
                    <!-- Campo oculto para pasar la instalación -->
                    <input type="hidden" name="instalacion" value="Campo de Fútbol Sala" />
