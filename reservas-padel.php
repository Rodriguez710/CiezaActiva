...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['fecha']) && isset($_POST['hora']) && isset($_POST['instalacion'])) {
    ...
    header("Location: reservas-padel.php");
    exit();
}
...
<body>
    ...
    <main>
        <div class="descripcion">
            <h2>Reserva del pista de Padel</h2>
            <p>¡Reserva tu horario para disfrutar de tu pista de padel!</p>
        </div>
        ...
        <div class="detalles">
            ...
            <div class="informacion">
                <form method="POST" id="reserva-form" action="reservas-padel.php">
                    <!-- Campo oculto para pasar la instalación -->
                    <input type="hidden" name="instalacion" value="Pista de padel" />
