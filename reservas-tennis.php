...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['fecha']) && isset($_POST['hora']) && isset($_POST['instalacion'])) {
    ...
    header("Location: reservas-tennis.php");
    exit();
}
...
<body>
    ...
    <main>
        <div class="descripcion">
            <h2>Reserva de la pista de tennis</h2>
            <p>¡Reserva tu horario para disfrutar de la pista de tennis!</p>
        </div>
        ...
        <div class="detalles">
            ...
            <div class="informacion">
                <form method="POST" id="reserva-form" action="reservas-tennis.php">
                    <!-- Campo oculto para pasar la instalación -->
                    <input type="hidden" name="instalacion" value="Pista de tennis" />
